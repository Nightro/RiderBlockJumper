...
namespace JetBrains.Rider.Model
{
  ...
  public class RiderBlockJumperModel : RdExtBase
  {
    //fields
    //public fields
    ...
    internal RiderBlockJumperModel (
    ) : this (
    ...
    protected override long SerializationHash => -8771156078703086461L;
    ...
    {
      printer.Println("RiderBlockJumperModel (");
  ...
  public static class SolutionRiderBlockJumperModelEx
   {
    public static RiderBlockJumperModel GetRiderBlockJumperModel(this Solution solution)
    {
      return solution.GetOrCreateExtension("riderBlockJumperModel", () => new RiderBlockJumperModel());
    }
  }
